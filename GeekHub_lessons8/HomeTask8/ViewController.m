...
//  homeWork3
//
//  Created by Yaroslav Gorkun on 03.12.14.
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.backgroundColor = [UIColor colorWithRed:2.0f/(indexPath.row + 2) green:6.4f/(indexPath.row + 1) blue:4.0f/(indexPath.row + 1) alpha:1.0f/(indexPath.row + 1)];
    return cell;
}
